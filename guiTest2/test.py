...
###########################Manual components##############################################        
        ...
        self.buttonFrequency = Tkinter.Button(self,text=u"Update Frequency",command=self.OnButtonClickFrequency)
        ...
        self.buttonPressure = Tkinter.Button(self,text=u"Update Pressure",command=self.OnButtonClickPressure)
        ...
        self.buttonTemperature = Tkinter.Button(self,text=u"Update Temperature",command=self.OnButtonClickTemperature)
        ...
        #Update grms button
        self.buttonGrms = Tkinter.Button(self,text=u"Update Grms",command=self.OnButtonClickGrms,state='active')
        self.buttonGrms.grid(column=1,row=10)
                        
        self.labelGrms = Tkinter.StringVar()
        label = Tkinter.Label(self,textvariable=self.labelGrms, anchor="w",fg="white",bg="blue")
